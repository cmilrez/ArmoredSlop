...
@abstract func set_up(spawn: Node3D, dmg_data: DamageData, target_pos: Vector3, _target: Character = null) -> void
...
func get_prediction(bullet_speed: float, target: Character) -> Vector3:
